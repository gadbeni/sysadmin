...
class DataTypesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('data_types')->insert(array (
            ...
            array (
                'id' => 23,
                'name' => 'direcciones_tipos',
                'slug' => 'direcciones-tipos',
                'display_name_singular' => 'Tipo de dirección administrativa',
                'display_name_plural' => 'Tipos de dirección administrativa',
                'icon' => 'voyager-list',
                'model_name' => 'App\\Models\\DireccionesTipo',
                'policy_name' => NULL,
                'controller' => NULL,
                'description' => NULL,
                'generate_permissions' => 1,
