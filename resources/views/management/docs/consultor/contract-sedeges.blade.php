        ...
        <div class="content">
            ...
            <p>
                <ul>
                    ...
                    <li><p>Ley  Nº 1546 del Presupuesto General del Estado Gestión 2024, de fecha 31 de diciembre del 2023.</p></li>
                    <li><p>Decreto Supremo Nº 5094, de fecha 03 de enero del 2024.</p></li>
            ...
            <p><strong><span>CL&Aacute;USULA VIG&Eacute;SIMA</span></strong><strong><span>.- (APORTES A LA GESTORA pÚBLICA DE SEGURIDAD SOCIAL A LARGO PLAZO)&nbsp; </span></strong><span> <b>{{ $contract->person->gender == 'masculino' ? 'El CONSULTOR' : 'La CONSULTORA' }}</b>  Individual de L&iacute;nea tiene la obligaci&oacute;n de la contribuci&oacute;n al Sistema Integral de Pensiones a Largo Plazo del porcentaje cotizable, administrativos por las GESTORA PÚBLICA, tal como lo establece la Ley N&deg; 065 del 10 de diciembre del 2010 y el Decreto Supremo N&deg; 0778 de 26 de enero del 2011.</span></p>
            <p><strong><span>CL&Aacute;USULA </span></strong><strong><span>VIG&Eacute;SIMA PRIMERA.- (DE LOS PASAJES Y VI&Aacute;TICOS) </span></strong><span>En caso de que se requiera la presencia de <b>{{ $contract->person->gender == 'masculino' ? 'el CONSULTOR' : 'la CONSULTORA' }}</b>  en un lugar distinto al lugar de la realizaci&oacute;n de la consultor&iacute;a, la <strong>ENTIDAD </strong>correr&aacute; con los gastos de pasajes y vi&aacute;ticos <b>{{ $contract->person->gender == 'masculino' ? 'del CONSULTOR' : 'de la CONSULTORA' }}</b>  contratado, tal como lo establece la Ley N&deg; 614 en su Art&iacute;culo 14&deg;, Par&aacute;grafo III, Inc. e).</span></p>
