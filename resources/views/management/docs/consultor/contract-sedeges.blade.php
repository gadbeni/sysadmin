...
@section('content')
    <div class="content" style="text-align: justify">
        <h2 class="text-center" style="font-size: 15px">CONTRATO ADMINISTRATIVO N&deg; {{ $code }} <br> "CONSULTOR INDIVIDUAL DE LÍNEA {{ Str::upper($contract->cargo->Descripcion).($contract->name_job_alt ? ' - '.$contract->name_job_alt : '') }} PARA LA/EL {{ Str::upper($contract->work_location ?? $contract->unidad_administrativa->nombre) }} DEL SEDEGES-BENI" </h2>
