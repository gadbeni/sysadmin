    ...
    @else
        <div class="content">
            ...
            <div class="page-body">
                ...
                <p><b>PLAZO DE PRESTACIÓN DE SERVICIO:</b> El consultor prestará el servicio a partir @if($contract->direccion_administrativa_id != 5) del siguiente día hábil @endif de la suscripción del contrato hasta el {{ date('d', strtotime($contract_finish)) }} de {{ $months[intval(date('m', strtotime($contract_finish)))] }} de {{ date('Y', strtotime($contract_finish)) }}.</p>
