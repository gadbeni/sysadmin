...
@section('content')
    <div class="content" style="text-align: justify">
        ...
        @endphp
        <h2 class="text-center">CONTRATO DE PRESTACION DE SERVICIOS DE PERSONAL EVENTUAL</h2>
        <h3 class="text-center">GAD-BENI-S.D.A.F  {{ $code }}</h3>
        <br>
        ...
        <p><em>1.- </em><em><strong>EL GOBIERNO AUT&Oacute;NOMO DEPARTAMENTAL DE BENI</strong></em><em>, con domicilio </em><em>ubicado en la Plaza Principal Mcal. Jos&eacute; Ballivi&aacute;n representado</em><em> legalmente para este acto por el Lic. </em><em><strong> Geisel Marcelo Oliva Ruiz con C.I &hellip;&hellip;&hellip;&hellip;, </strong></em><em><strong>en su calidad de </strong></em><em><strong>Secretario Departamental de Administraci&oacute;n y Finanzas (S.D.A.F) GAD-Beni</strong></em><em><strong>,</strong></em><em> designado mediante Decreto de </em><em><strong>Gobernaci&oacute;n </strong></em><em><strong>N&deg; &hellip;/2021 de ../../21, </strong></em><em>y designado como Autoridad responsable de Procesos de Contrataci&oacute;n - RPA, Autoridad responsable de procesos de contrataci&oacute;n de Licitaci&oacute;n Publica &ndash; RPC y contrataciones directas, que en adelante se denominara </em><em><strong>LA ENTIDAD</strong></em><em>. </em></p>
        ...
        <p><em>-Reglamento Interno de Personal del Gobierno Aut&oacute;nomo Departamental de Beni, en todo lo que sea aplicable y compatible con la naturaleza jur&iacute;dica de este contrato.</em></p>
        <p><em>En ese marco el </em><em><strong>CONTRATADO</strong></em><em> no estar&aacute; bajo el r&eacute;gimen de la Ley General del Trabajo ni el Decreto Reglamentario 224 de fecha 23 de agosto de 1943, quedando el </em><em><strong>CONTRATANTE </strong></em><em>sujeto a las disposiciones emitidas del Ministerio de Econom&iacute;a en cuanto al</em><em><strong> </strong></em><em> pago de aguinaldo u otra clase de beneficio adicional.</em></p>
        ...
        <p><em>a) Curr&iacute;culum Vitae del Contratado</em></p>
        ...
        <p><em>La ENTIDAD, contrata los servicios del CONTRATADO para desempe&ntilde;ar la funci&oacute;n de </em><em>{{ Str::upper($contract->cargo->Descripcion) }}</em><em>, en dependencias de la/el </em><em>{{ Str::upper($contract->unidad_adminstrativa->NOMBRE) }}</em><em> dependiente de </em><em>la Secretaria de Administracion y Finanzas</em><em> con un </em><em>nivel Salarial 14</em><em> con cargo a la partida presupuestaria 12100 (Personal Eventual), en los t&eacute;rminos y condiciones que se establecen en este contrato, debiendo coadyuvar y coordinar sus actividades con su inmediato superior y las dem&aacute;s &aacute;reas de La ENTIDAD, donde sean requeridas. El presente contrato bajo ninguna manera podr&aacute; ser motivo de transferencia, subrogaci&oacute;n, delegaci&oacute;n, total o parcialmente.</em></p>
        ...
        <p><em>-Coordinar la planificaci&oacute;n, ejecuci&oacute;n y seguimiento de las actividades del &aacute;rea.</em></p>
        <p><em>-Proporcionar apoyo t&eacute;cnico en la ejecuci&oacute;n de pol&iacute;ticas y objetivos de la Entidad </em></p>
        <p><em>-Informar, recomendar y emitir criterios t&eacute;cnico-administrativos a su inmediato superior en lo que corresponde al &aacute;rea de su especialidad.</em></p>
        ...
        <p><em>-Presentar informes mensuales, trimestrales o de la manera que su superior inmediato solicite seg&uacute;n los programas de evaluaci&oacute;n y cumplimiento de objetivos de la Entidad en formato impreso y digital.</em></p>
        <p><em>-Manejar en forma ordenada, sistematizada y archivada toda la documentaci&oacute;n bajo su cargo.</em></p>
        <p><em>-Participar en otras funciones delegadas</em><em> </em></p>
        ...
        <p><em>-</em><em>Cumplir lo dispuesto en la Constituci&oacute;n Pol&iacute;tica del Estado, Leyes, Decretos y Resoluciones Nacionales y Departamentales.</em></p>
        <p><em>-Gozar del Seguro de salud para lo cual se deber&aacute; a</em><em>filiar a la Caja de Seguro Social donde estuviera registrado el </em><em>Gobierno Aut&oacute;nomo del Departamento del Beni</em><em>, debiendo presentar toda la documentaci&oacute;n personal y de sus familiares dependientes si los tuviera para dicha afiliaci&oacute;n. </em></p>
        <p><em>-</em><em>Cumplir los horarios de ingreso y salida, debiendo incorporarse a su lugar de trabajo inmediatamente despu&eacute;s del marcado de tarjeta o sistema de control de asistencia bajo conminatoria de los descuentos respectivos.</em></p>
        <p><em><strong>-</strong></em><em>Preservar y cuidar los activos fijos, material, equipos de computaci&oacute;n, documentaci&oacute;n y todo cuanto fuere asignado para el desempe&ntilde;o de funciones, una vez terminado o resuelto el contrato proceder a la respectiva devoluci&oacute;n.</em></p>
        <p><em><strong>-</strong></em><em>Garantizar y responder por la funci&oacute;n asignada de tal forma que, de ser requerida su presencia f&iacute;sica para cualquier aclaraci&oacute;n posterior a la vigencia del contrato, se obliga a no negar su participaci&oacute;n.</em></p>
        ...
        <p><em>- Al pago oportuno de los aportes patronales a la Seguridad Social de Corto Plazo.</em></p>
        ...
        <p><em>En se&ntilde;al de aceptaci&oacute;n y estricto cumplimiento firman el presente Contrato en tres ejemplares de un mismo tenor y validez, el Lic. Geisel Marcelo Oliva Ruiz</em><em><strong>, Secretario Departamental de Administraci&oacute;n y Finanzas </strong></em><em><strong> </strong></em><em>y por otra parte </em><em>Sr. Jose Perez Perez</em><em>, en calidad de CONTRATADO.</em></p>
        
        <br>
        <br>
        <p><em>Sant&iacute;sima Trinidad, 18 de Enero de 202</em><em>2</em></p>
        ...
        <table width="100%" style="text-align: center; margin: 80px 0px; margin-bottom: 50px">
            <tr>
                <td style="width: 50%">
                    ...
                    <b>Secretario Departamental de Administración y Finanzas</b>
                </td>
                <td style="width: 50%">
                    ....................................................... <br>
