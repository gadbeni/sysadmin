...
@section('content')
    <div class="content">
        <div class="page-head">
            <p><strong>1er. CONTRATO MODIFICATORIO DE PERSONAL EVENTUAL {{ $signature ? $signature->direccion_administrativa->sigla : 'UJ/SDAF' }} N&deg; {{ $addendums->first()->code }} RELACIONADO AL CONTRATO {{ $signature ? $signature->direccion_administrativa->sigla : 'UJ/SDAF' }}/GAD-BENI N&deg; {{ $code }} </strong></p>
        </div>
        <p>&nbsp;</p>
