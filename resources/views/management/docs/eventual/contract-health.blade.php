...
@section('content')
    ...
    @else
        <div class="content">
            <div class="page-head">
                <h3>CONTRATO DE PRESTACI&Oacute;N DE SERVICIOS PARA PERSONAL EVENTUAL<br>GAD-BENI-C.E-{{ $code }}</h3>
            </div>
            ...
            <p><em>El objeto y causa del presente contrato es la prestaci&oacute;n de servicios de un&nbsp; PERSONAL EVENTUAL por parte del (A) </em><strong><em>CONTRATADO (A), </em></strong><em>para desempe&ntilde;ar la funci&oacute;n de&nbsp;</em><strong><em>{{ Str::upper($contract->cargo->Descripcion) }}</em></strong><em> {{ $contract->requested_by ? ', solicitado por '.Str::upper($contract->requested_by) : '' }}, bajo dependencias del Servicio Departamental de Salud </em><strong><em>SEDES BENI, </em></strong>en el marco de las cl&aacute;usulas contenidas en el presente contrato y Manual de Funciones de la instituci&oacute;n; nombramiento que a mayor abundamiento.</p>
