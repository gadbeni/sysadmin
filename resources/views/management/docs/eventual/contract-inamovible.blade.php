...
@section('content')
    ...
    @else
        <div class="content">
            ...
            <p><em>El Clasificador Presupuestario de la presente gesti&oacute;n en el grupo {{ $contract->program->number }}, Empleados No Permanentes, se&ntilde;ala que son gastos para remunerar los servicios prestados y otros beneficios a personas sujetas a contrato en forma transitoria o eventual, para MISIONES ESPEC&Iacute;FICAS, PROGRAMAS Y PROYECTOS DE INVERSI&Oacute;N, considerando para el efecto, la equivalencia de funciones y la escala salarial de acuerdo a la normativa vigente.</em></p>
            ...
            <p>
                <ul>
                    ...
                    <li><em><b>Ley Nº 223 Ley General para personas con Discapacidad.</b></em></li>
                    <li><em><b>Ley Nº 977 Ley de Inserción laboral y de ayuda económica para las personas con discapacidad. </b></em></li>
                    <li><em>Código de Seguridad Social, de 14 de diciembre de 1956.</em></li>
                    <li><em>Decreto Supremo 23318-A, de 3 de noviembre de 1992, que aprueba el Reglamento de la Responsabilidad por la Función Pública y su Decreto Supremo, modificado por el Decreto Supremo 26237 y Decreto Supremo N&deg; 29536 de 30 de abril de 2008.</em></li>
            ...
            <p><em>En ese marco {!! $contract->person->gender == 'masculino' ? 'el <b>CONTRATADO</b>' : 'la <b>CONTRATADA</b>' !!} no estar&aacute; bajo el r&eacute;gimen de la Ley General del Trabajo ni el Reglamento de la Ley General del Trabajo, DS N&deg; 224 de fecha 23 de agosto de 1943.</em></p>
            ...
            <p><em>c) Resolución Judicial de Tutoría y Carnet de Discapacidad del Beneficiario, emitido por el Ministerio de Salud registrado en el SIPRUN-PCD (Sistema Único de Registro de Personas con Discapacidad) y Fotocopia del Dictamen de Discapacidad emitido por la Comisión de Calificación del SEDES cuando corresponda.</em></p>
            <p><em>d) Carnet de Discapacidad de la Contratada, emitido por el Ministerio de Salud registrado en el SIPRUN-PCD (Sistema Único de Registro de Personas con Discapacidad y Fotocopia del Dictamen de Discapacidad emitido por la Comisión de Calificación del SEDES cuando corresponda).</em></p>
            <p><em>e) Fotocopia de Cedula de Identidad.</em></p>
            <p><em>f) Otros documentos requeridos por la Dirección de Recursos Humanos del GAD-BENI según Instructivo de inicio de contratación de personal.</em></p>
            ...
            <p><em><span style="text-decoration: underline;"><strong>CLÁUSULA DECIMA PRIMERA .- </strong></span><strong>(CAUSALES PARA RESOLUCIÓN DEL CONTRATO)</strong></em></p>
            ...
            <ul>
                ...
                <li><p><em>Realizarse examen médico-técnico para establecer la Discapacidad a largo Plazo o Permanente, cuando corresponda.</em></p></li>
