...
@section('content')
    <div class="content" style="text-align: justify">
        ...
        <p><em><span style="text-decoration: underline;"><strong>CLÁUSULA SEGUNDA</strong></span><strong>.-</strong> <strong>(ANTECEDENTES).- </strong>La Ley No 1546, Ley del Presupuesto General del Estado Gesti&oacute;n 2024, determina en su Disposici&oacute;n Final Segunda la vigencia entre otros de la Ley del Presupuesto General del Estado, aprobado en el marco del articulo 158 numeral 11 de la Constituci&oacute;n Pol&iacute;tica del Estado, que en su el art. 22 (Ley de presupuesto general del Estado 2010)determina; "La remuneraci&oacute;n del Personal Eventual debe establecerse considerando las funciones y la escala salarial aprobada de la <b>ENTIDAD</b>, para la cual no se requiere ning&uacute;n instrumento legal adicional".</em></p>
        <p><em>Por su parte el art&iacute;culo 13 del D.S. 5094 de 03 de enero de 2024, se&ntilde;ala (Nivel de remuneraci&oacute;n del personal Eventual)</em></p>
        ...
        <p>
            <ul>
                ...
                <li><em>Ley N° 1546 de 31 de diciembre de 2023, Presupuesto General del Estado - Gestión 2024.</em></li>
                <li><em>Decreto Supremo No 5094, de fecha 03 de enero de 2024, “Reglamento a la Ley 1546”.</em></li>
                ...
                <li><em>Decreto Supremo 23318-A, de 3 de noviembre de 1992, que aprueba el Reglamento de la Responsabilidad por la Función Pública y su Decreto Supremo, modificado por el Decreto Supremo 26237 y Decreto Supremo N&deg; 29536 30 de abril de 2008</em></li>
        ...
        <p><em>En ese marco {!! $contract->person->gender == 'masculino' ? 'el <b>CONTRATADO</b>' : 'la <b>CONTRATADA</b>' !!} no estar&aacute; bajo el r&eacute;gimen de la Ley General del Trabajo ni el Reglamento de la Ley General del Trabajo, DS N&deg; 224, 23 de agosto de 1943.</em></p>
        ...
        <p><em>c) Cuadro de Equivalencia de Funciones-Personal Eventual.</em></p>
        <p><em>d) Otros documentos requeridos por la Dirección de Recursos Humanos GAD BENI según Instructivo de inicio de contratación de personal.</em></p>
        <p><em><span style="text-decoration: underline;"><strong>CLÁUSULA QUINTA</strong></span><strong>.-</strong> <strong>(OBJETO).-</strong></em></p>
        <p><em>La <b>ENTIDAD</b>, contrata los servicios {!! $contract->person->gender == 'masculino' ? '<b>del CONTRATADO</b>' : 'de la <b>CONTRATADA</b>' !!} para desempe&ntilde;ar la funci&oacute;n de <b>{{ Str::upper($contract->name_job_alt ?? $contract->cargo->Descripcion) }}</b>, en dependencias de la/el <b>{{ Str::upper($contract->unidad_administrativa->nombre) }}</b> dependiente de la/el <b>{{ Str::upper($contract->direccion_administrativa->nombre) }}</b> con el nivel salarial <b>{{ $contract->cargo->nivel->where('IdPlanilla', $contract->cargo->idPlanilla)->first()->NumNivel }}</b> con cargo a la partida presupuestaria {{ $contract->program->number }} (Personal Eventual), en los t&eacute;rminos y condiciones que se establecen en este contrato y sus MISIONES ESPECIFICAS, debiendo coadyuvar y coordinar sus actividades con su inmediato superior y las dem&aacute;s &aacute;reas de la <b>ENTIDAD</b>, donde sean requeridas. El presente contrato bajo ninguna manera podr&aacute; ser motivo de transferencia, subrogaci&oacute;n, delegaci&oacute;n, total o parcialmente.</em></p>
        <p><em><span style="text-decoration: underline;"><strong>CLÁUSULA SEXTA</strong></span><strong>.-</strong> <strong>(CONDICIONES).-</strong></em></p>
        <p><em>6.1. FUNCIONES {!! $contract->person->gender == 'masculino' ? 'DEL <b>CONTRATADO</b>' : 'DE LA <b>CONTRATADA</b>' !!}: Deber&aacute; cumplir las funciones que se establecen de forma enunciativa y no limitativa según su <b>MISIÓN ESPECÍFICA</b>.</em></p>
        ...
        <p><em>{!! $contract->person->gender == 'masculino' ? 'El <b>CONTRATADO</b>' : 'La <b>CONTRATADA</b>' !!} cumplir&aacute; con el horario de trabajo de {{ ($contract->direccion_administrativa_id == 32 || $contract->direccion_administrativa_id == 53) ? '6' : '8' }} Horas diarias que ser&aacute; de {{ ($contract->direccion_administrativa_id == 32 || $contract->direccion_administrativa_id == 53) ? '7:30 a 13:30' : '8:00 a 12:30 y de 14:30 a 18:00' }}</strong> <strong>de lunes a viernes</strong>, en el lugar que le sea asignado, así mismo, de acuerdo a necesidades Institucionales se podr&aacute; cambiar el horario manteniendo las {{ ($contract->direccion_administrativa_id == 32 || $contract->direccion_administrativa_id == 53) ? '6' : '8' }} Horas laborales, adem&aacute;s el servidor deber&aacute; prestar servicios fuera de los horarios establecidos, conforme instrucción de sus superiores, mediante informe y/o cronograma de turno.</em></p>
        ...
        <p><em><b>MODIFICACIONES AL CONTRATO</b></em></p>
        <p>
            <ul>
                <li><p><em>Las modificaciones al contrato deberán estar destinadas al cumplimiento del objeto de la contratación y ser sustentadas por informe técnico y legal que establezca la viabilidad técnica y de financiamiento.</em></p></li>
                <li><p><em>Esta modificación podrá realizarse hasta un máximo de dos (2) veces, no debiendo exceder el plazo de cada modificación al establecido en el contrato principal.</em></p></li>
                <li><p><em>Es aplicable cuando la modificación a ser introducida afecte el alcance, monto y/o plazo del contrato, sin dar lugar al incremento de los precios unitarios. El Contrato Modificatorio será suscrito por la MAE o por la autoridad que suscribió el contrato principal.</em></p></li>
            </ul>
        </p>
        <p><em><span style="text-decoration: underline;"><strong>CLÁUSULA DECIMA .- </strong></span><strong>(PASAJES Y VIATICOS)</strong></em></p>
	    <p><em>Los gastos por pasajes, vi&aacute;ticos que se requieran para el desarrollo de las actividades del funcionario público en las provincias y/o capitales de Bolivia, ser&aacute;n proporcionados por el Gobierno Aut&oacute;nomo Departamental del Beni.</em></p>
        <p><em><span style="text-decoration: underline;"><strong>CLÁUSULA DECIMA PRIMERA .- </strong></span><strong>(CAUSALES PARA RESOLUCION DEL CONTRATO)</strong></em></p>
        ...
        <p><em><strong>b)</strong> Por acúmulo de tres (3) llamadas de atención por incumplimiento de sus obligaciones y/o por omisión, negligencia o descuido en las mismas, durante la vigencia de su contratación, previo proceso sumario adminstrativo.</em></p>
        ...
        <p><em><strong>d)</strong> Por asistir a su fuente laboral, bajo influencias de bebidas alcohólicas, sustancias controladas, estupefacientes y psicotrópicas o consumir las mismas en instalaciones del GAD - Beni.</em></p>
        <p><em><strong>e)</strong> Inasistencia injustificada de tres (3) días hábiles consecutivos o seis (6) días hábiles discontinuos en un (1) mes, previo proceso sumario administrativa.</em></p>
        <p><em><strong>f)</strong> Abuso de confianza, robo, hurto debidamente comprobado.</em></p>
        <p><em><strong>g)</strong> Por prisión formal de {!! $contract->person->gender == 'masculino' ? 'el <b>CONTRATADO</b>' : 'la <b>CONTRATADA</b>' !!}, emergente de sentencia condenatoria ejecutoriada.</em></p>
        <p><em><strong>h)</strong> Por negligencia demostrada en el cumplimiento de sus deberes que tengan como resultado el daño económico al Estado y a la Institución o el desprestigio de ésta.</em></p>
        <p><em><strong>i)</strong> Cuando {!! $contract->person->gender == 'masculino' ? 'el <b>CONTRATADO</b>' : 'la <b>CONTRATADA</b>' !!} está comprendido(a) dentro de las incompatibilidades o prohibiciones para ejercer la función pública, por razón de parentesco hasta el cuarto grado de consanguineidad y segundo de afinidad.</em></p>
        <p><em><strong>j)</strong> Cuando se evidencie que {!! $contract->person->gender == 'masculino' ? 'el <b>CONTRATADO</b>' : 'la <b>CONTRATADA</b>' !!} percibe dos remuneraciones en calidad de servidor público que provengan de recursos públicos, conforme a normas en vigencia o incurre en incompatibilidad por conflicto de intereses según el formulario respectivo.</em></p>
        <p><em><strong>k)</strong> Por infracción de las normas internas que rigen en la ENTIDAD (Reglamento Interno de Personal - RIP) y otras causales previstas en la normativa legal aplicable.</em></p>
        <p><em><strong>l)</strong> Cuando la <b>ENTIDAD</b> advierta que, durante la ejecución del contrato, {!! $contract->person->gender == 'masculino' ? 'el <b>CONTRATADO</b>' : 'la <b>CONTRATADA</b>' !!} incurra en incumplimiento, negligencia o ineficiencia en el desarrollo de las funciones previstas en la cláusula quinta, previo informe fundamentado del Jefe Inmediato Superior, resolverá unilateralmente el contrato. Asimismo, cuando la <b>ENTIDAD</b> advierta inobservancia de {!! $contract->person->gender == 'masculino' ? 'el <b>CONTRATADO</b>' : 'la <b>CONTRATADA</b>' !!} en el cumplimiento de las normas internas o cuando ésta incurra en actos irregulares, dolosos, culposos, u otros que signifiquen actos de corrupción y/o de trasgresión al ordenamiento jurídico administrativo, sin necesidad de proceso administrativo, trámite judicial o extrajudicial, se dispondrá la resolución del contrato; sin perjuicio de las responsabilidades establecidas por ley.</em></p>
        <p><em>En todos los casos en que las causales se determinen atribuibles a {!! $contract->person->gender == 'masculino' ? 'el <b>CONTRATADO</b>' : 'la <b>CONTRATADA</b>' !!}, éste asumirá todas las responsabilidades emergentes del presente contrato, en el marco de la Ley N°1178 de Administración y Control Gubernamentales y el Reglamento de la Responsabilidad por la Función Pública.</em></p>
        <p><em>1.2. Resolución por voluntad {!! $contract->person->gender == 'masculino' ? 'del <b>CONTRATADO</b>' : 'de la <b>CONTRATADA</b>' !!} comunicada a la INSTITUCIÓN para aceptación de mutuo acuerdo, previo aviso escrito al CONTRATANTE solicitando Resolución de Contrato, previa entrega de informes correspondientes, activos fijos, cualquier otra documentación que está a su cargo.</em></p>
        ...
        <p><em><strong>CLÁUSULA D&Eacute;CIMA SEGUNDA: (DERECHOS Y OBLIGACIONES {{ $contract->person->gender == 'masculino' ? 'DEL CONTRATADO' : 'DE LA CONTRATADA' }})</strong></em></p>
            ...
            <li>
                ...
                <p>
                    <ol>
                        ...
                        <li><p><em>Por fallecimiento de padres, cónyuge, hermanos o hijos, 3 (tres) días hábiles de licencia inmediatos al hecho; debiendo el Servidor o Servidora pública, presentar en copias el Certificado de Defunción pertinente, dentro de los siguientes 5 (cinco) días hábiles siguientes de ocurrido el suceso.</em></p></li>
                        ...
                        <li><p><em>Por cuestiones de índole personal se otorgará 03 (Tres) día hábil con goce de haberes y 3 (tres) sin goce de haberes, durante la vigencia del contrato, estos días no serán acumulables, este beneficio debe ser autorizado por el Jefe inmediato Superior o Jerárquico.</em></p></li>
                        <li><p><em>Podrá gozar de permiso para realizar gestiones personales, por un máximo de una hora y media al mes, las cuales no serán acumulables ni de uso obligatorio, pero si podrán ser divisibles en un mismo mes, gozando la percepción del cien por ciento de sus haberes.</em></p></li>
                    </ol>
                </p>
            </li>
        ...
        <ul>
            ...
            <li><p><em>Proceder a la devolución de los activos fijos, materiales, que hubieran sido otorgados por el GAD BENI y documentación a su cargo en formato físico y digital, una vez terminado y/o resuelto el presente contrato, para dicho efecto tendrá un <b>plazo de 48 horas</b>.</em></p></li>
        </ul>
        ...
        <p><em><strong>CLÁUSULA D&Eacute;CIMA TERCERA: (OBLIGACIONES DE LA ENTIDAD.)</strong></em></p>
