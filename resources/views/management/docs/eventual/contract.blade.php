...
@section('content')
    <div class="content" style="text-align: justify">
        ...
        <p><em>c) Certificación presupuestaria 2024.</em></p>
        <p><em>d) Certificación POA 2024.</em></p>
        <p><em>e) Cuadro de Equivalencia de Funciones-Personal Eventual.</em></p>
        <p><em>f) Otros documentos requeridos por la Dirección de Recursos Humanos GAD BENI según Instructivo de inicio de contratación de personal.</em></p>
        ...
        <p><em>{!! $contract->person->gender == 'masculino' ? 'El <b>CONTRATADO</b>' : 'La <b>CONTRATADA</b>' !!} cumplir&aacute; con el horario de trabajo de 8:00 Hrs diarias que ser&aacute; de {{ $contract->direccion_administrativa_id == 32 ? '7:30 a 13:30' : '8:00 a 12:30 y de 14:30 a 18:00' }}</strong> <strong>de lunes a viernes</strong>, en el lugar que le sea asignado, así mismo, de acuerdo a necesidades Institucionales se podr&aacute; cambiar el horario manteniendo las 8 Horas laborales, adem&aacute;s el servidor deber&aacute; prestar servicios fuera de los horarios establecidos, conforme instrucci&oacute;n verbal o escrita que reciba de sus superiores. , asimismo las inasistencias, atrasos, permisos y DESCUENTOS estar&aacute;n en sujeci&oacute;n al Reglamento Interno de Personal del Gobierno Aut&oacute;nomo Departamental del Beni.</em></p>
        ...
        <p><em><span style="text-decoration: underline;"><strong>CLÁUSULA NOVENA .- </strong></span><strong>(PASAJES Y VIATICOS)</strong></em></p>
        ...
        <p><em><span style="text-decoration: underline;"><strong>CLÁUSULA DECIMA .- </strong></span><strong>(CAUSALES PARA RESOLUCION DEL CONTRATO)</strong></em></p>
        ...
        <p><em><strong>b)</strong> Por acúmulo de dos (2) llamadas de atención (graves) por incumplimiento de sus obligaciones y/o por omisión, negligencia o descuido en las mismas, durante la vigencia de su contratación.</em></p>
        ...
        <p><em><strong>CLÁUSULA D&Eacute;CIMA PRIMERA: (DERECHOS Y OBLIGACIONES {{ $contract->person->gender == 'masculino' ? 'DEL CONTRATADO' : 'DE LA CONTRATADA' }})</strong></em></p>
