            ...
            <div class="page-head" style="width: 100%">
                <div class="border-right">
                    <p style="position:absolute; bottom: 10px">
                        ...
                        <span id="label-location">Santísima Trinidad</span>, {{ date('d', strtotime($rotation->date)) }} de {{ $months[intval(date('m', strtotime($rotation->date)))] }} de {{ date('Y', strtotime($rotation->date)) }}
                    </p>
                </div>
