...
@section('page_title', 'Reporte de cargos')

@if(auth()->user()->hasPermission('browse_reportshumans-resourcesjobs'))
                    ...
                    <div class="panel panel-bordered">
                        <div class="panel-body" style="padding: 0px">
                            <div class="col-md-8" style="padding: 0px">
                                <h1 class="page-title">
                                    <i class="voyager-calendar"></i> Reporte de cargos
                                </h1>
                            ...
                            <div class="col-md-4" style="margin-top: 30px">
                                <form name="form_search" id="form-search" action="{{ route('reports.humans_resources.jobs.list') }}" method="post">
                                    @csrf
