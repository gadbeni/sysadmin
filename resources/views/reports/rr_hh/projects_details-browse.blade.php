                    ...
                    <div class="panel panel-bordered">
                        <div class="panel-body" style="padding: 0px">
                            <div class="col-md-8" style="padding: 0px">
                                <h1 class="page-title">
                                    <i class="voyager-dollar"></i> Reporte de Ejecución de Programas/proyectos
                                </h1>
                            ...
                            <div class="col-md-4" style="margin-top: 30px">
                                <form name="form_search" id="form-search" action="{{ route('reports.humans_resources.projects.details.list') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="year" value="{{ date('Y') }}" class="form-control" placeholder="Gestión" required>
                                    </div>
