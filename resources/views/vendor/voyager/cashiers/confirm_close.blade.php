                ...
                <div class="panel panel-bordered">
                    <div class="row">
                        ...
                        @php
                            ...
                            $total_cashier = 0;
                            foreach($cashier->details as $details){
                                $total_cashier += $details->cash_value * $details->quantity;
                            }
                        @endphp
                        <div class="col-md-6" style="padding-top: 20px">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <p style="margin-top: 20px">Pagos realizados</p>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="panel-heading" style="border-bottom:0;">
                                        <h3 class="text-right" style="padding-right: 20px" id="label-total">{{ number_format($total_cashier, 2, ',', '.') }}</h3>
                                    </div>
                                </div>
                            </div>
                            @php
                                $missing_amount = $total - $total_cashier;
                                $plus_amount = $total_cashier - $total;
                            @endphp
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="panel-heading" style="border-bottom:0;">
                                        <h3 class="text-right" style="padding-right: 20px" id="label-missing_amount">{{ number_format($missing_amount > 0 ? $missing_amount : 0, 2, ',', '.') }}</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="panel-heading" style="border-bottom:0;">
                                        <h3 class="text-right" style="padding-right: 20px" id="label-missing_amount">{{ number_format($plus_amount > 0 ? $plus_amount : 0, 2, ',', '.') }}</h3>
                                    </div>
                                </div>
                            </div>
